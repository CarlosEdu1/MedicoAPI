...
public class MedicoController {
    ...
    @PostMapping
    @Transactional
    public void cadastrarMedico(@RequestBody @Valid DadosCadastroMedico dados) {//cadastrar um medico
    ...
    public void excluir(@PathVariable Long id){
        ...
        medicos.excluir();
        //essa anotação serve para identificar que a variavel
        //id é a mesma que ta sendo passada na anotation deleteMap
    }
}
